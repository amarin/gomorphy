...
5. Этап 18, но сначала — груминг CLI-команд (есть отдельные идеи,
...
5. Связь с 2-байтовым DAWG-алфавитом (см. п.4 «Путь к версии 1.0.0»
   выше): мультисловарь с отдельным алфавитом на каждый язык и один
